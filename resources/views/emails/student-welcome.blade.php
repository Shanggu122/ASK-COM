...
<body>
  <div class="container">
    ...
    <p>
      <a class="btn" href="{{ $loginUrl }}" target="_blank" rel="noopener" style="background:#14532d;color:#ffffff !important;text-decoration:none;display:inline-block;padding:10px 16px;border-radius:6px;font-weight:600;">Go to Student Portal</a>
    </p>

    <p class="muted">If you encounter any issues, please contact the administrator.</p>

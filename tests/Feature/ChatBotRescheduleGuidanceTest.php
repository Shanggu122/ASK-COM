...
class ChatBotRescheduleGuidanceTest extends TestCase
{
    ...
    public function test_how_to_reschedule_returns_guidance_not_professor_fallback()
    {
        $res = $this->post("/chat", ["message" => "how to reschedule"]);
